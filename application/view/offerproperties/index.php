<div class="container-fluid">
	...
	<!-- content -->
	<main role="main" class="offerproperties">
  
  <div><b>Настройка свойств офферов</b></div>
  <div>
      ...
      <tbody>
        <?php foreach ($OCs as $inst) { ?>
            <tr>
                ...
                <td><a href="<?php echo URL . 'offerproperties/delete/' . $inst->id ?>">Удалить</a>/<a href="<?php echo URL . 'offerproperties/edit/' . $inst->id ?>" class="editoffercategory">Редактировать</a></td>
            </tr>
        <?php } ?>
      </tbody>
    </table>
...
<form class="formoffercategory" action="<?php echo URL . 'offercategory/addcategory/'?>" method="post">
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input name="url" type="text" class="form-control" id="validationDefault03" placeholder="URL" value="" required>
    </div>
  </div>
