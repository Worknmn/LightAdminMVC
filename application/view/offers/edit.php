<div class="container-fluid">
  ...
  -->
	<main role="main" class="offers-edit">
  
  <div><b>Редактирование оффера</b></div>
  
  <div>
    <?php //require APP . 'view/offerpropertycategorybind/form.php';?>
    
<form class="form-offer-edit" action="<?php echo URL . 'offers/update/'?>" method="post">
  <div class="form-row">
    <input name="id" type="hidden" class="form-control" value="<?php echo $Oto->id; ?>">
    <input name="submit_edit_offer" type="hidden" class="form-control" value="Y">
    <div class="col-md-4 mb-3">
      <label for="validationDefault01">Сортировка</label>
      <input name="sort" type="text" class="form-control" id="validationDefault01" placeholder="Сортировка" value="<?php echo $Oto->sort; ?>" required>
    </div>
    <div class="col-md-4 mb-3">
      <label for="validationDefault02">Название</label>
      <input name="name" type="text" class="form-control" id="validationDefault02" placeholder="Название" value="<?php echo $Oto->name; ?>" required>
    </div>
    <div class="col-md-4 mb-3">
      <label for="validationDefault03">URL</label>
      <input name="alias" type="text" class="form-control" id="validationDefault03" placeholder="URL" value="<?php echo $Oto->alias; ?>" required>
    </div>
  </div>
  ...
  <div class="form-row">
    <div class="col-md-12 mb-3">
      ...
      <textarea id="descriptioneditor" name="text"><?php if (isset($Oto->text)) echo $Oto->text;?></textarea>
    </div>
  </div>
  
  <div class="form-row">
    <div class="col-md-12 mb-3">
      <label for="validationDefault06">Реф.ссылка</label>
      <input name="refurl" type="text" class="form-control" id="validationDefault06" placeholder="Реф.ссылка" value="<?php echo $Oto->refurl; ?>" >
    </div>
  </div>
  ...
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <select class="offercategoryid" name="offercategoryid" required>
        ...
        <option value="<?php if (isset($inst->id)) echo $inst->id;?>"<?php if ($inst->id==$Oto->categoryid) echo " selected";?>><?php if (isset($inst->name)) echo $inst->name;?></option>
        <?php } ?>
      </select>
    </div>    
  </div>
  ...
  <div class="form-row properties">
    <?php //\Mini\Libs\Helper::vdw($OV);
      $properties = $OV;
    ?>
    <?php require APP . 'view/offers/properties.php';?> 
  </div>
