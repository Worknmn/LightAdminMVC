...
class Model
{
    ...
    private function openDatabaseConnection()
    {
        ...
        // @see http://www.php.net/manual/en/pdostatement.fetch.php setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $options = array(PDO::ATTR_DEFAULT_FETCH_MODE => PDO::FETCH_OBJ, PDO::ATTR_ERRMODE => PDO::ERRMODE_WARNING);
        //$options = array(PDO::ATTR_DEFAULT_FETCH_MODE => PDO::FETCH_OBJ, PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION);    все warning становятся ошибкой
